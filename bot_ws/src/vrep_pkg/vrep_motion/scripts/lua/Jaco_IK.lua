...
--if not path then
local m=getShiftedMatrix(simGetObjectMatrix(target1,-1),{0.1,0,0.1},-1)
...
--simWait(1.25)
--
--local m=simGetObjectMatrix(target1,-1)
--path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
--
--if path then
--    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
--path,lengths=loadPath('jacoPath_3')
--if not path then
--    local m=simGetObjectMatrix(target2,-1)
--    path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
--    if path then
--        savePath('jacoPath_3',path,lengths)
--    end
--end
--if path then
--    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
--simSetIntegerSignal('yourTurnMico',1)
--
---- Pour the cup content into the other cup  (with IK):
--path,lengths=loadPath('jacoPath_4')
--if not path then
--    local m=simGetObjectMatrix(target3,-1)
--    path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
--    if path then
--        savePath('jacoPath_4',path,lengths)
--    end
--end
--if path then
--    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
--path,lengths=loadPath('jacoPath_5')
--if not path then
--    local m=simGetObjectMatrix(target2,-1)
--    path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
--    if path then
--        savePath('jacoPath_5',path,lengths)
--    end
--end
--if path then
--    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
--path,lengths=loadPath('jacoPath_6')
--if not path then
--    local m=getShiftedMatrix(simGetObjectMatrix(target1,-1),{0,0.01,0},-1)
--    path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
--    if path then
--        savePath('jacoPath_6',path,lengths)
--    end
--end
--if path then
--    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
--path,lengths=loadPath('jacoPath_8')
--if not path then
...
--    displayInfo(nil)
--    if path then
--        savePath('jacoPath_8',path,lengths)
--    end
--end
--if path then
--    visualizePath(path)
