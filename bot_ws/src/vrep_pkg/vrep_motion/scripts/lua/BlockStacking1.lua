...
target4=simGetObjectHandle('jacoTarget4')
target5=simGetObjectHandle('jacoTarget5')
target6=simGetObjectHandle('jacoTarget6')
target7=simGetObjectHandle('jacoTarget7')
target8=simGetObjectHandle('jacoTarget8')
target9=simGetObjectHandle('jacoTarget9')
...
local m=simGetObjectMatrix(target4,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
...
local m=simGetObjectMatrix(target5,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
...
local m=simGetObjectMatrix(target6,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
...
simSetIntegerSignal("hand",1)
simWait(3.0)
local m=simGetObjectMatrix(target8,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
if path then
    visualizePath(path)
    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
local m=simGetObjectMatrix(target7,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
if path then
    visualizePath(path)
    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
...
local m=simGetObjectMatrix(target9,-1)
path,lengths=generateIkPath(getConfig(),m,ikSteps,true)
if path then
    visualizePath(path)
    executeMotion(path,lengths,maxVel,maxAccel,maxJerk)
