// Generated by gencpp from file rbt_baxter_msgs/SEAJointState.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_SEAJOINTSTATE_H
#define RBT_BAXTER_MSGS_MESSAGE_SEAJOINTSTATE_H
...
struct SEAJointState_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> const> ConstPtr;

}; // struct SEAJointState_

typedef ::rbt_baxter_msgs::SEAJointState_<std::allocator<void> > SEAJointState;

typedef boost::shared_ptr< ::rbt_baxter_msgs::SEAJointState > SEAJointStatePtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::SEAJointState const> SEAJointStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd36406dcbb6d860bULL;
  static const uint64_t static_value2 = 0x1b39c4e28f81352bULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/SEAJointState";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::SEAJointState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RBT_BAXTER_MSGS_MESSAGE_SEAJOINTSTATE_H
