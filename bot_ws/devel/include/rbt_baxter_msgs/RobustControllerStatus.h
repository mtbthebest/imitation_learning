// Generated by gencpp from file rbt_baxter_msgs/RobustControllerStatus.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
#define RBT_BAXTER_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
...
struct RobustControllerStatus_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> const> ConstPtr;

}; // struct RobustControllerStatus_

typedef ::rbt_baxter_msgs::RobustControllerStatus_<std::allocator<void> > RobustControllerStatus;

typedef boost::shared_ptr< ::rbt_baxter_msgs::RobustControllerStatus > RobustControllerStatusPtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::RobustControllerStatus const> RobustControllerStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f15441b7285d915ULL;
  static const uint64_t static_value2 = 0xe7e59d3618e173f2ULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/RobustControllerStatus";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::RobustControllerStatus_<ContainerAllocator>& v)
  {
    s << indent << "isEnabled: ";
...
#endif // RBT_BAXTER_MSGS_MESSAGE_ROBUSTCONTROLLERSTATUS_H
