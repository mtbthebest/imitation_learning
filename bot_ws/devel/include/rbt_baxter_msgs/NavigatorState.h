// Generated by gencpp from file rbt_baxter_msgs/NavigatorState.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_NAVIGATORSTATE_H
#define RBT_BAXTER_MSGS_MESSAGE_NAVIGATORSTATE_H
...
struct NavigatorState_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> const> ConstPtr;

}; // struct NavigatorState_

typedef ::rbt_baxter_msgs::NavigatorState_<std::allocator<void> > NavigatorState;

typedef boost::shared_ptr< ::rbt_baxter_msgs::NavigatorState > NavigatorStatePtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::NavigatorState const> NavigatorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x680d121a1f16a326ULL;
  static const uint64_t static_value2 = 0x47298b292492fffdULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/NavigatorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# buttons\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::NavigatorState_<ContainerAllocator>& v)
  {
...
#endif // RBT_BAXTER_MSGS_MESSAGE_NAVIGATORSTATE_H
