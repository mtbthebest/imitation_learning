// Generated by gencpp from file rbt_baxter_msgs/EndEffectorCommand.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
#define RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
...
struct EndEffectorCommand_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorCommand_

typedef ::rbt_baxter_msgs::EndEffectorCommand_<std::allocator<void> > EndEffectorCommand;

typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorCommand > EndEffectorCommandPtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorCommand const> EndEffectorCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc003234e90416f2cULL;
  static const uint64_t static_value2 = 0xa02ac7837c42cbb7ULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/EndEffectorCommand";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::EndEffectorCommand_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORCOMMAND_H
