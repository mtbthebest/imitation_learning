// Generated by gencpp from file rbt_baxter_msgs/EndEffectorState.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORSTATE_H
#define RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORSTATE_H
...
struct EndEffectorState_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorState_

typedef ::rbt_baxter_msgs::EndEffectorState_<std::allocator<void> > EndEffectorState;

typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorState > EndEffectorStatePtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorState const> EndEffectorStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "3973a05119eb82a45fb9c002c11329fd";
  }

  static const char* value(const ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3973a05119eb82a4ULL;
  static const uint64_t static_value2 = 0x5fb9c002c11329fdULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/EndEffectorState";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::EndEffectorState_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORSTATE_H
