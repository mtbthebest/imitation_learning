// Generated by gencpp from file rbt_baxter_msgs/EndEffectorProperties.msg
// DO NOT EDIT!


#ifndef RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
#define RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
...
struct EndEffectorProperties_
{
  ...
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> const> ConstPtr;

}; // struct EndEffectorProperties_

typedef ::rbt_baxter_msgs::EndEffectorProperties_<std::allocator<void> > EndEffectorProperties;

typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorProperties > EndEffectorPropertiesPtr;
typedef boost::shared_ptr< ::rbt_baxter_msgs::EndEffectorProperties const> EndEffectorPropertiesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x21b83773ab9a3521ULL;
  static const uint64_t static_value2 = 0x6d11e427573c76ccULL;
};

template<class ContainerAllocator>
struct DataType< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  static const char* value()
  {
    return "rbt_baxter_msgs/EndEffectorProperties";
  }
...
template<class ContainerAllocator>
struct Definition< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rbt_baxter_msgs::EndEffectorProperties_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // RBT_BAXTER_MSGS_MESSAGE_ENDEFFECTORPROPERTIES_H
