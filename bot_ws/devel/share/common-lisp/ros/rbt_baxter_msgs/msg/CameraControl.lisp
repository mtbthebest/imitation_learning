...
(cl:defmethod cl:initialize-instance :after ((m <CameraControl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CameraControl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rbt_baxter_msgs-msg:<CameraControl> is deprecated: use rbt_baxter_msgs-msg:CameraControl instead.")))
