...
(cl:defclass <EndpointStates> (roslisp-msg-protocol:ros-message)
  ((names
   ...
   (states
    :reader states
    :initarg :states
    :type (cl:vector rbt_baxter_msgs-msg:EndpointState)
   :initform (cl:make-array 0 :element-type 'rbt_baxter_msgs-msg:EndpointState :initial-element (cl:make-instance 'rbt_baxter_msgs-msg:EndpointState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EndpointStates>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EndpointStates)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rbt_baxter_msgs-msg:<EndpointStates> is deprecated: use rbt_baxter_msgs-msg:EndpointStates instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EndpointStates>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'states)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rbt_baxter_msgs-msg:EndpointState))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EndpointStates>)))
  ...
  "rbt_baxter_msgs/EndpointStates")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EndpointStates)))
  "Returns string type for a message object of type 'EndpointStates"
  "rbt_baxter_msgs/EndpointStates")
