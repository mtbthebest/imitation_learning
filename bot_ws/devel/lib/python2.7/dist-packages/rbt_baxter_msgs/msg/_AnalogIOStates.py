...
"""autogenerated by genpy from rbt_baxter_msgs/AnalogIOStates.msg. Do not edit."""
import sys
...
class AnalogIOStates(genpy.Message):
  ...
  _type = "rbt_baxter_msgs/AnalogIOStates"
...
"""
  ...
  _slot_types = ['string[]','rbt_baxter_msgs/AnalogIOState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = rbt_baxter_msgs.msg.AnalogIOState()
        _v2 = val1.timestamp
        _x = _v2
        start = end
        end += 8
