...
"""autogenerated by genpy from rbt_baxter_msgs/EndpointStates.msg. Do not edit."""
import sys
...
class EndpointStates(genpy.Message):
  ...
  _type = "rbt_baxter_msgs/EndpointStates"
...
"""
  ...
  _slot_types = ['string[]','rbt_baxter_msgs/EndpointState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.states = []
      for i in range(0, length):
        val1 = rbt_baxter_msgs.msg.EndpointState()
        _v12 = val1.header
        start = end
        end += 4
