...
"""autogenerated by genpy from rbt_baxter_msgs/OpenCameraRequest.msg. Do not edit."""
import sys
...
class OpenCameraRequest(genpy.Message):
  ...
  _type = "rbt_baxter_msgs/OpenCameraRequest"
...
"""
  ...
  _slot_types = ['string','rbt_baxter_msgs/CameraSettings']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.settings is None:
        self.settings = rbt_baxter_msgs.msg.CameraSettings()
    else:
      self.name = ''
      self.settings = rbt_baxter_msgs.msg.CameraSettings()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rbt_baxter_msgs.msg.CameraControl()
        _x = val1
        start = end
        end += 8
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rbt_baxter_msgs/OpenCameraResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class OpenCameraResponse(genpy.Message):
  ...
  _type = "rbt_baxter_msgs/OpenCameraResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class OpenCamera(object):
  _type          = 'rbt_baxter_msgs/OpenCamera'
